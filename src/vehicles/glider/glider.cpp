...
void Glider::setClassCaps()
{
    ...
    thMain[0] = veh->createThruster({-1, 0, -7}, {0, 0, 1}, 2e6, phMain, ISP, ISP);
    thMain[1] = veh->createThruster({ 1, 0, -7}, {0, 0, 1}, 2e6, phMain, ISP, ISP);
    thgrpMain = veh->createThrusterGroup(thMain, 2, thgMain);

    // Retro engine thrusters
    thRetro[0] = veh->createThruster({-3, 0, 5}, {0, 0, -1}, 3.4e4, phMain, ISP, ISP);
    thRetro[1] = veh->createThruster({ 3, 0, 5}, {0, 0, -1}, 3.4e4, phMain, ISP, ISP);
    thgrpRetro = veh->createThrusterGroup(thRetro, 2, thgRetro);

    // Hover engine thrusters
    thHover[0] = veh->createThruster({ 0, 0,  3}, {0, 1, 0}, 1.4e5, phMain, ISP, ISP);
    thHover[1] = veh->createThruster({-3, 0, -4}, {0, 1, 0}, 3/4*0.5*1.4e5, phMain, ISP, ISP);
    thHover[2] = veh->createThruster({ 3, 0, -4}, {0, 1, 0}, 3/4*0.5*1.4e5, phMain, ISP, ISP);
    thgrpHover = veh->createThrusterGroup(thHover, 3, thgHover);

    // Rotation/linear attitude thrusters
    thAttRot[0] = thAttLin[0] = veh->createThruster({ 0, 0, 8}, { 0, 1, 0}, 2.5e3, phAtt, ISP);
    thAttRot[1] = thAttLin[3] = veh->createThruster({ 0, 0,-8}, { 0,-1, 0}, 2.5e3, phAtt, ISP);
    thAttRot[2] = thAttLin[2] = veh->createThruster({ 0, 0, 8}, { 0,-1, 0}, 2.5e3, phAtt, ISP);
    thAttRot[3] = thAttLin[1] = veh->createThruster({ 0, 0,-8}, { 0, 1, 0}, 2.5e3, phAtt, ISP);
    ...
    thAttRot[4] = thAttLin[4] = veh->createThruster({ 0, 0, 6}, {-1, 0, 0}, 2.5e3, phAtt, ISP);
    thAttRot[5] = thAttLin[7] = veh->createThruster({ 0, 0,-6}, { 1, 0, 0}, 2.5e3, phAtt, ISP);
    thAttRot[6] = thAttLin[6] = veh->createThruster({ 0, 0, 6}, { 1, 0, 0}, 2.5e3, phAtt, ISP);
    thAttRot[7] = thAttLin[5] = veh->createThruster({ 0, 0,-6}, {-1, 0, 0}, 2.5e3, phAtt, ISP);
    ...
    thAttRot[8]  = veh->createThruster({ 6, 0, 0}, { 0, 1, 0}, 2.5e3, phAtt, ISP);
    thAttRot[9]  = veh->createThruster({-6, 0, 0}, { 0,-1, 0}, 2.5e3, phAtt, ISP);
    thAttRot[10] = veh->createThruster({-6, 0, 0}, { 0, 1, 0}, 2.5e3, phAtt, ISP);
    thAttRot[11] = veh->createThruster({ 6, 0, 0}, { 0,-1, 0}, 2.5e3, phAtt, ISP);
    ...
    thAttLin[8]  = veh->createThruster({ 0, 0,-7}, { 0, 0, 1}, 2.5e3, phAtt, ISP);
    thAttLin[9]  = veh->createThruster({ 0, 0, 7}, { 0, 0,-1}, 2.5e3, phAtt, ISP);
